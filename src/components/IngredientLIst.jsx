export default function IngredientList(props){ 
    ...
    return(
        <section className={props.recipeList.length == 0 ? "hidden" : "my-8 space-y-4 visible"}>
                ...
                </ul>
            {
                ...
                <div className="flex justify-between items-center p-8 bg-neutral-200 rounded my-8">
                    ...
                    <button className="bg-orange-700/60 text-neutral-50 px-7 py-1 rounded h-fit">Search</button>
                </div>
            }
        </section>
    )
